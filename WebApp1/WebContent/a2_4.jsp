		...
		//  Variablen fuer September
			...
			window.onload = function () {
				...
				//Diagramm fuer das ganze Jahr
					var options = {
						title: {
							text: "Häufigkeit aller Hashtags im Zeitverlauf auf Monatsebene - Durch Klicken auf die Balken werden die einzelnen Monate angezeigt"
						},
				...
				// Diagramm fuer Januar
					var jan = {
							title: {
								text: "Häufigkeit aller Hashtags im Zeitverlauf im Januar"
							},
					                animationEnabled: true,
							data: [
							{
					...
					var feb = {
							title: {
								text: "Häufigkeit aller Hashtags im Zeitverlauf im Februar"
							},
					                animationEnabled: true,
							data: [
							{
					...
					var mar = {
							title: {
								text: "Häufigkeit aller Hashtags im Zeitverlauf im März"
							},
					                animationEnabled: true,
							data: [
							{
					...
					var apr = {
							title: {
								text: "Häufigkeit aller Hashtags im Zeitverlauf im April"
							},
					                animationEnabled: true,
							data: [
							{
					...
					var may = {
							title: {
								text: "Häufigkeit aller Hashtags im Zeitverlauf im Mai"
							},
					                animationEnabled: true,
							data: [
							{
					...
					var jun = {
							title: {
								text: "Häufigkeit aller Hashtags im Zeitverlauf im Juni"
							},
					                animationEnabled: true,
							data: [
							{
					...
					var jul = {
							title: {
								text: "Häufigkeit aller Hashtags im Zeitverlauf im Juli"
							},
					                animationEnabled: true,
							data: [
							{
					...
					var aug = {
							title: {
								text: "Häufigkeit aller Hashtags im Zeitverlauf im August"
							},
					                animationEnabled: true,
							data: [
							{
					...
					var sep = {
							title: {
								text: "Häufigkeit aller Hashtags im Zeitverlauf im Septemeber"
							},
					                animationEnabled: true,
							data: [
							{
